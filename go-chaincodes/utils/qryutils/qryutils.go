...
func constructQueryResponseFromIterator(resultsIterator shim.StateQueryIteratorInterface) (*bytes.Buffer, string) {
	fmt.Println("- Starting qryutils constructQueryResponseFromIterator")
	...
	fmt.Println("- Ending qryutils constructQueryResponseFromIterator")
	return &b, "SUCCESS"
}
...
func GetQueryResultForQueryString(stub shim.ChaincodeStubInterface, queryString string) (string, string) {
	fmt.Printf("- Starting qryutils GetQueryResultForQueryString queryString:\n%s\n", queryString)
	...
	fmt.Printf("- Ending qryutils GetQueryResultForQueryString queryResult:\n%s\n", b.String())
